...
bool DVTest::ReadTestConfig(std::string config_file) {
  ...
  if (!cfg) {
    std::cout << "ERRROR Test not found: "
...
DVTestResetMode DVTest::GetResetMode() {
  return reset_mode_;
}

DVCSRMode DVTest::GetCSRMode() {
  return csr_mode_;
}
...
std::string DVTest::StringResetMode() {
  switch (reset_mode_) {
    case kDVResetOnce : return "Reset Once";
    case kDVResetOccasional : return "Reset Occasionally";
    case kDVResetStress : return "Reset Stress";
    default : return "WARNING: Unknown mode";
  }
}

std::string DVTest::StringCSRMode() {
  switch (csr_mode_) {
    case kDVCSRRandom : return "CSR Random";
    case kDVCSRStress : return "CSR Stress";
    case kDVCSRBusAccess : return "CSR Bus Access";
    case kDVCSRAbsCmd : return "CSR Abstract Command";
    default : return "WARNING: Unknown mode";
  }
}
...
std::string DVTest::StringHostMode() {
  switch (host_mode_) {
    case kDVHostIdle : return "Host Idle";
    case kDVHostRandom : return "Host Random";
    case kDVHostDelays : return "Host Delay";
    default : return "WARNING: Unknown mode";
  }
}
...
std::string DVTest::StringDeviceMode() {
  switch (device_mode_) {
    case kDVDeviceRandom : return "Device Random";
    case kDVDeviceDelays : return "Device Delay";
    default : return "WARNING: Unknown mode";
  }
}
